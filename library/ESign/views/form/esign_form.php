    ...
    <form id='esign-signature-form' method='post' action='<?php echo attr($this->form->action); ?>'>
        ...
        <div class="esign-signature-form-element form-group">
            ...
            <input type='password' class="form-control" id='password' name='password' size='10' placeholder="<?php echo xla("Enter your password to sign the form"); ?>" />
              <!--ALB The following is to set focus to the password textbox -->
              <script type="text/javascript" language="JavaScript">
                 document.forms['esign-signature-form'].elements['password'].focus();
              </script>
        </div>
        ...
        <div class="esign-signature-form-element">
              <!--ALB I switched which button is pressed by default when enter is pressed -->
              <input type='button' class="btn btn-secondary btn-sm" value='<?php echo xla('Back'); ?>' id='esign-back-button' /> 
              <input type='submit' class="btn btn-primary btn-sm" value='<?php echo xla('Sign'); ?>' id='esign-sign-button-form' />
        </div>
