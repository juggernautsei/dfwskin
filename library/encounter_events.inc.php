...
//ALB Check to see if the encounter is cosmetic, in which case, //charge the entire amount to the patient.
//
function isCosmetic($patient_id, $encounter) {
    $tmp = sqlQuery("SELECT c.cosmetic FROM codes as c, " .
        "billing as b WHERE b.pid = ' $patient_id ' AND " .
        "b.encounter = ' $encounter ' AND b.activity = 1 AND " .
