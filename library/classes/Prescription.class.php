    ...
    */
    ...
    function get_dosage_display($display_form = "")
    {
        if (empty($this->form) && empty($this->interval)) {
            ...
            //ALB Changed the look of this line to include more info
            return ($this->size . $this->unit_array[$this->unit] . " " . $this-> dosage . " " . $this->form_array[$this->form] . " " . $this->route_array[$this->route]. " " . $this->interval_array[$this->interval] . " (" . oeFormatShortDate($this->date_modified) . ")");
