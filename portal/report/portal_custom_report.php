...
if ($printable) {
  ...
  *******************************************************************/
  ...
  /******************************************************************/
    ...
    //ALB Not needed    echo '<page_footer style="text-align:right;">' . xlt('Generated on') . ' ' . text(oeFormatShortDate()) . ' - ' . text($facility['name']) . ' ' . text($facility['phone']) . '</page_footer>';
...
<!--ALB Not needed here <a href="javascript:window.close();"><span class='title'><?php echo text($titleres['fname']) . " " . text($titleres['lname']); ?></span></a><br /> -->
...
if ($printable) {
    //ALB Don't need this  echo "<br /><br />" . xlt('Signature') . ": _______________________________<br />";
}
?>
