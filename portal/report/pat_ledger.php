...
function PrintEncHeader($dt, $rsn, $dr)
{
    ...
    //ALB Changed this echo "<td colspan='4'><span class='bold'>".xlt('Encounter Dt / Rsn'). ": </span><span class='detail'>".text(substr($dt, 0, 10))." / ".text($rsn)."</span></td>";
    echo "<td colspan='2'><span class='bold'>".xlt('Encounter Date'). ": </span><span class='detail'>".text(substr($dt, 0, 10))."</span></td>";
    echo "<td colspan='2'><span class='bold'>".xlt('Encounter Reason'). ": </span><span class='detail'>".text($rsn)."</span></td>";
