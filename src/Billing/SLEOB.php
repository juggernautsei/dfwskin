...
class SLEOB
{
    ...
    // ALB Added claim_number to ar_activity table
    //
    public static function arPostPayment(
        ...
        if (!$claim_number) $claim_number = ''; //ALB
        ...
        $query = "INSERT INTO ar_activity ( " .
            ...
            "session_id, memo, pay_amount, claim_number " .
            ") VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
        sqlStatement(
            $query,
            array(
    ...
    // ALB Added claim number to ar_activity table
    //
    public static function arPostAdjustment($patient_id, $encounter_id, $session_id, $amount, $code, $payer_type, $reason, $debug, $time = '', $codetype = '', $claim_number = '')
    {
        $codeonly = $code;
        $modifier = '';
        $tmp = strpos($code, ':');
        ...
        $query = "INSERT INTO ar_activity ( " .
            ...
            "session_id, memo, adj_amount, claim_number " .
            ") VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
        sqlStatement($query, array($patient_id, $encounter_id, $sequence_no['increment'], $codetype, $codeonly, $modifier, $payer_type, $_SESSION['authUserID'], $time, $session_id, $reason, $amount, $claim_number));
        sqlCommitTrans();
        return;
    }
