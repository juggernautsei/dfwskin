            ...
            if (modifiers_are_used(true)) {
                if ($codetype != 'COPAY' && (!empty($code_types[$codetype]['mod']) || $modifier)) {
                    echo "  <td class='billcell'><input type='text' class='form-control' name='bill[" . attr($lino) . "][mod]' " .
                        "title='" . xla("Multiple modifiers can be separated by colons or spaces, maximum of 4 (M1:M2:M3:M4). ") . //ALB Added modifiers below
                        "Examples: 25 - separately identifiable E&M, 59 - distinct procedure performed on the same day, " .
                        "XS - distinct procedure performed on the same day on a separate structure, " .
                        "24 - unrelated E&M service during  postoperative period, " .
                        "79 - unrelated procedure during postoperative period, " .
                        "57 - E&M that resulted in decision to perform surgery, " .
                        "58 - related procedure during postoperative period, 76 - repeat procedure by same physician, " .
                        "GW - service not related to hospice patient`s terminal condition, E1 - left upper eyelid, " .
                        "E2 - left lower eyelid, E3 - right upper eyelid, E4 - right lower eyelid" . "' " .
...
//ALB - Find out if within global period for procedures
...
<body>
    <div id="container_div" class="<?php echo attr($oemr_ui->oeContainer()); ?> mt-3">
        <div class="row">
            ...
            <!--ALB Brought the Review (Coding history) button up here -->
                        <div class='col-12'>
                ...
                <div class="clearfix" style=color:red><b><h5>
                        <?php
            ...
            <div class="col-12">
                ...
                onsubmit="return validate(this)">
                    ...
                    if ($isBilled) {
                        ...
                        ?>
                        <fieldset>
                        <h7><b><?php echo xlt('Set Price Level'); ?><//b></h7> <!--ALB Changed from legend tags -->
                            <div class='form-group mx-3 text-center'>  <!--ALB Changed to mx-3 here to line up -->
                                <?php
                                ...
                                if (true) {
                                    ...
                                    echo "<select name='pricelevel' class='form-control' style='width:250px;font-size:90%' onchange='defaultPriceLevelChanged(this)' ";  //ALB Added style
                                    if ($isBilled) {
                                        echo " disabled";
                                    }
                                    echo ">\n";
                    ...
                    <fieldset>
                    <h7><b><?php echo xlt("Select Code")?><h7><b> <!--ALB Changed from legend tag -->
                    <div class='text-center'>
                        <table class="table" width="95%">
                            ...
                            while ($row = sqlFetchArray($res)) {
                                ...
                                if ($fs_category !== $last_category) {
                                    ...
                                    echo ($i <= 1) ? " <tr>\n" : "";
                                    echo "  <td class='text-nowrap' width='20%'>\n"; //ALB Change to 20% here
                            ...
                            while ($prow = sqlFetchArray($pres)) {
                                ...
                                ++$i;
                                echo ($i <= 1) ? " <tr>\n" : "";
                                echo "  <td class='text-center text-nowrap' width='20%'>\n";  //ALB Change to 20% here
                                echo "   <select class='form-control' onchange='codeselect(this)'>\n";
                                ...
                                echo "   </select>\n";
                                echo "  </td>\n";
                                if ($i >= 5) { //ALB Change here $FEE_SHEET_COLUMNS) {
                                    echo " </tr>\n";
                                    $i = 0;
                                }
                            }
                        ...
                        <fieldset>
                            <b><h7><?php echo xlt("Search for Additional Codes")?></b></h7> <!--ALB Changed from legend tag -->
                                    <div class="input-group-append"> <!--ALB Changed all the divs for this section and added a table here -->
				<table class="table" width=95% cellpadding="0" cellspacing="0">
				<td style='width:10%' align='left' nowrap> <!--ALB All my formatting -->
                                    <?php
                                    ...
                                    foreach ($nofs_code_types as $key => $value) {
                                        ...
                                        echo " />  " . xlt(substr($value['label'],0,strpos($value['label'],' '))) . "&nbsp;\n"; //ALB Changed from xlt($value['label']) 
                                        echo " </label>";
                                    }
                                    ?>

				    </td><td width='20%' align='left' nowrap> <!--ALB My formatting -->
                  
                                        <input type='text' class="billcell" name='search_term' value='' /> <!--ALB My formatting -->
					...
					<?php
                                    ...
                                    if (! $numrows) {
                                        ...
                                        echo "   <select name='search_results' " . // ALB style='background: var(--yellow)' " .
                    ...
                    <fieldset>
                        <b><h7><?php echo xlt("Selected Fee Sheet Codes and Charges for Current Encounter")?></b></h7><!--ALB Instead of /legend>

                        <!--ALB This is copied over to the top
                        <div class='col-12'>
                            <table class="table" name='copay_review' id='copay_review'>
                                <tr>
                                    <?php
                    ...
                    <fieldset>
                        <b><h7><?php echo xlt("Select Providers"); ?></h7></b><!--ALB changed from /legend -->
                        <div class="row mx-5">
