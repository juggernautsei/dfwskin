...
<!--ALB <th> <?php echo xlt('Refer To'); ?> </th> -->
<th> <?php echo xlt('Refer Date'); ?> </th>
<!--ALB <th> <?php echo xlt('Reply Date'); ?> </th> -->
<th> <?php echo xlt('Patient'); ?> </th>
<th> <?php echo xlt('ID'); ?> </th>
<th> <?php echo xlt('Referral To'); ?> </th> <!--ALB -->
...
<tbody>
    ...
    if ($_POST['form_refresh']) {
        ...
        "d7.field_value AS refer_to, " . //ALB
