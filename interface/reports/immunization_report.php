...
if (!empty($_POST['form_get_hl7']) && ($_POST['form_get_hl7'] === 'true')) {
    $query .=
        ...
        "c.code, " .
        "c.code_type, " .
        "DATE_FORMAT(i.update_date,'%Y%m%d') as immunizationdate, " . //ALB Changed from vis_date to update_date
    ...
    $query .= "concat(p.fname, ' ',p.mname,' ', p.lname) as patientname, " .
        "i.update_date as immunizationdate, "; //ALB Changed from vis_date to update_date
}
...
if (!empty($form_from_date)) {
    //ALB Use update date instead  $query .= "i.vis_date >= ? and " ;
    $query .= "i.update_date >= ? and " ;
            ...
            <div id="report_results">
                <table class='table'>
                    ...
                    <tr>
                        ...
                        <!-- ALB Add this line -->
                        <th> <?php echo xlt('Documentation Date','e'); ?> </th>
                    ...
                    while ($row = sqlFetchArray($res)) {
                        ...
                        <tr>
                            ...
                            <!-- ALB Added this -->
                            <td>
			        <?php echo text(oeFormatShortDate($row['administered_date'])); ?>
			    </td>
