    ...
    <tr>
        ...
        <table class='text'>
            ...
            <tr>
                ...
                <td>
                    <div class="checkbox">
                        ...
                        <?php  echo ($show_available_times) ? ' checked' : ''; ?>> <?php
                ...
                <td>
                    <div class="checkbox">
                        ...
                        # This will include the reminder for the patients on the report ?>>
                ...
                <td> <!--ALB Adding to show canceled appts -->
                    <div class="checkbox">
                        ...
                        <?php  echo ($show_canceled) ? ' checked' : ''; ?>> <?php
                            echo xlt('Show Canceled'); # check this to show canceled appointments ?>
                        </label>
                    </div>
                </td>
            ...
            <tr>
                ...
                <td>
                    <div class="checkbox">
                        <label><input type="checkbox" name="with_out_provider" id="with_out_provider"
                                <?php echo ($chk_with_out_provider) ? "checked" : ""; ?>>
                ...
                <td>
                    <div class="checkbox">
                        <label><input type="checkbox" name="with_out_facility" id="with_out_facility"
                                <?php echo ($chk_with_out_facility) ? "checked" : ""; ?>>&nbsp;
        ...
        <table class='w-100 h-100' style='border-left: 1px solid;'>
                        ...
                        <div class="btn-group" role="group">
                            ...
                            <?php if (!empty($_POST['form_refresh']) || !empty($_POST['form_orderby'])) { ?>
                                ...
                                <a href='#' class='btn btn-secondary btn-transmit'
                                   onclick='window.open("../patient_file/printed_fee_sheet.php?fill=2", "_blank").
                                   opener = null' onsubmit='return top.restoreSession()'>
                                    <?php echo xlt('Superbills'); ?>
                                </a>
                                <a href='#' class='btn btn-secondary btn-transmit'
                                   onclick='window.open("../patient_file/addr_appt_label.php", "_blank").
                                   opener = null' onsubmit='return top.restoreSession()'>
            ...
            <tr>&nbsp;&nbsp;
                <?php //ALB Don't need this   echo xlt('Most column headers can be clicked to change sort order') ?>
            </tr>
        </table>
        </td>
    </tr>
...
<table class='table'>
    ...
    $appointments = fetchAppointments(
            ...
            $provider,
            $facility,
            ($show_canceled ? $form_apptstatus : 'NO_SHOW'),
            $with_out_provider,
            $with_out_facility,
            $form_apptcat
    );
    ...
    foreach ($appointments as $appointment) {
        ...
        <!-- ALB Don't need <td class="detail">&nbsp;
            ...
            <td class="detail">&nbsp;<?php echo "<input type='checkbox' name='form_cb[" . text($appointment['pid']) .
                    ";" . text(oeFormatShortDate($appointment['pc_eventDate'])) . "]' />"; ?></td>
    </tr>
...
<!--ALB Adding checkboxes for progress notes -->
    <div style='float;margin-top:5px'>
        ...
        <a href='javascript:;' class='btn btn-primary btn-transmit' onclick='$("#form_progress2").attr("value","true"); $("#theform").submit();'>
