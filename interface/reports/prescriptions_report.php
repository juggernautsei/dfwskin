...
<th> <?php echo xlt('Rx Date'); ?> </th> <!--ALB Added here-->
...
<tbody>
    ...
    if ($_POST['form_refresh']) {
        ...
        //ALB Changed form, size, unit to prescription table rather than drug table
        $query = "SELECT r.id, r.patient_id, " .
        "r.date_modified, r.dosage, r.route, r.interval, r.refills, r.drug, " .
        "d.name, d.ndc_number, r.form, r.size, r.unit, d.reactions, " .
  ...
  <td> <!--ALB Added this -->
            <?php echo text(oeFormatShortDate($row['date_modified'])); ?>
  </td>
  <td>
