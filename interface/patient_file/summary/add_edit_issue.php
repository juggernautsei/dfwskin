                ...
                <div class='col-sm-12'>
                    <form class="form-horizontal" name='theform' method="post" onsubmit='return validate()'>
                        ...
                        <div class="form-group col-12" id='row_occurrence'>
                            ...
                            //ALB Changed to ' ' for empty title to give a blank line
                        ...
                        <div class="form-group col-12" id='row_severity'>
                            ...
                            //ALB Changed to ' ' for empty title to give a blank line
                            generate_form_field(array('data_type' => 1, 'field_id' => 'severity_id', 'list_id' => 'severity_ccda', 'empty_title' => ' '), $severity);
                            ?>
                        </div>
                        <div class="form-group col-12" id='row_reaction'>
                            <label class="col-form-label" for="form_reaction"><?php echo xlt('Reaction'); ?>:</label>
                            <?php
                            //ALB Removed last 3 '' from the line below to include a blank option in the drop-down box
                        ...
                        if ($GLOBALS['ippf_specific']) {
                            ...
                            <?php
                            //ALB Added a space between '' in the 5th position below to include a blank line as an option
