...
if (empty($administered_by) && empty($administered_by_id)) {
    ...
    //ALB Set it to blank by default
    $administered_by = '';
                        ...
                        <select class="form-control" name="administered_by_id" id='administered_by_id'>
                                    <option value=""></option>
                                        ...
                                        $sql = "select id, CONCAT_WS(' ',lname,fname) as full_name " .
                                            "from users where username != '' and password != 'NoLogin' and active = 1 " . //ALB Only display active users
                                            "order by full_name";
                        ...
                        <select class="form-control" name="ordered_by_id" id='ordered_by_id'>
                            <option value=""></option>
                                ...
                                $sql = "select id, CONCAT(IFNULL(lname,''), ' ,',IFNULL(fname,'')) as full_name " .
                                    "from users where username != '' and password != 'NoLogin' and active = 1 and authorized = 1 " . //ALB Only display providers
                                    "order by full_name";
