...
<a href='authorizations_full.php' onclick='top.restoreSession()'>
    <?php echo xlt('Authorizations'); ?> </span><span class='more'><?php echo text($tmore); ?></span></a>
    <?php
} else { //ALB Changed this to show at least title here for those not authorized
?>
<span class='title'>
  <?php echo xlt('Authorizations'); ?></span>
  <br>
  <?php echo xlt('You are not authorized to use this function'); ?>
<?php
}
?>
