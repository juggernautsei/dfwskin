...
/**
 *  ALB change made to make the upper search behave like the on page search
 *  set sSearch to the value of searchAny and now it behaves like the on page search box.
 */
if ($searchAny <> "") $_GET['sSearch'] = $searchAny;
unset($searchAny);
